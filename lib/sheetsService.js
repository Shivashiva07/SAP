...
/** "2026-08-22" in the configured TZ (process.env.TZ), independent of locale. */
function todayString(date = new Date()) {
  return date.toLocaleDateString('en-CA'); // en-CA formats as YYYY-MM-DD
}

/** "14:05:32" in the configured TZ. */
function timeString(date = new Date()) {
  return date.toLocaleTimeString('en-GB'); // en-GB formats as HH:MM:SS (24h)
}
